...
while True:
  ...
  cv2.imwrite(r"C:\Users\ABHISHEK KUMAR\Desktop\SHOTS\shot.jpg",p)
  ...
  for j in (1,1500):
    h1 = Image.open(r"C:\Users\ABHISHEK KUMAR\Desktop\DATASET\shot"+str(j)+".jpg").histogram()
    h2 = Image.open(r"C:\Users\ABHISHEK KUMAR\Desktop\SHOTS\shot.jpg").histogram()
    ...
    if (rms<450):
      print("Accident")
      cv2.imwrite(r"C:\Users\ABHISHEK KUMAR\Desktop\email\accident.jpg",frame)
      SendMail(r"C:\Users\ABHISHEK KUMAR\Desktop\email\accident.jpg")
